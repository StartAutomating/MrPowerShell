<#
.SYNOPSIS
    The Blue Sky Butterfly SVG
.DESCRIPTION
    A documented step by step construction of the Blue Sky Butterfly SVG
.LINK
...
<svg width="100%" height="100%">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 320" class="foreground-stroke">
            <path class='foreground-fill foreground-stroke' fill="#0085ff" stroke='#0085ff' d="$sequenceSteps" />
        </svg>
</svg>
"@

$svg > ./BlueSkyButterfly.svg
$svg
Pop-Location