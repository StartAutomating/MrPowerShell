...
@{
    ...
    Position = "Senior Software Developer Engineer"
    StartDate = [DateTime]"2016-07"
    EndDate = [DateTime]"2018-01"
    Summary = "Migrated Intune Deployment from Jenkins to Azure DevOps and and Intune automation"
    Highlights = @(
...
@{
    ...
    Position = 'Senior DevOps Engineer'
    StartDate = [DateTime]'2014-09'
    EndDate = [DateTime]'2015-06'
...
@{
    ...
    StartDate = [DateTime]"2014-07"
    EndDate = [DateTime]"2014-12"
...
@{
    Name = "Microsoft (thru Start-Automating)"
    Position = "Senior Software Developer Engineer"
    StartDate = [DateTime]"2011-06"
    EndDate = [DateTime]"2012-05"
...
@{
    Name = "Microsoft (thru Start-Automating)"
    Position = "Senior Software Developer Engineer"
    StartDate = [DateTime]"2010-10"
    EndDate = [DateTime]"2012-01"
...
@{
    ...
    StartDate = [DateTime]"2006-01"
    EndDate = [DateTime]"2010-05"
...
@{
    ...
    StartDate = [DateTime]"2005-01"
    EndDate = [DateTime]"2006-01"
